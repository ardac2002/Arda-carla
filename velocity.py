...
subprocess.check_output(f"python3 spawn_npc.py", shell=True)
...
tesla = world.spawn_actor(tesla_bp, spawn_points[i])
...
#lidar_bp.set_attribute('sensor_tick', '0.00055555')
lidar_bp.set_attribute('dropoff_general_rate', '0.0')
lidar_bp.set_attribute('points_per_second', '1440000')
